...
const Account=()=>{
    ...
    return (
        <div>
                ...
                <div class="container-account_content">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>admin</td>
                            <td><FaEdit className='edit' onClick={handleShowEditUserAccount}/><FaTrash className='delete'/></td>
                        </tr>
                        <tr>
                            <td>user2</td>
            ...
            <div className="add-user-account" style={{display: showAddUserAccount ? "block" : "none"}}>
            ...
            <div className="edit-user-account" style={{display: showEditUserAccount ? "block" : "none"}}>
